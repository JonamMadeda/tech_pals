...
export default function HomeStats() {
  ...
  const stats = [{ label: "MEMBERS", value: counts.members, icon: Users, color: "text-blue-700 bg-blue-50" }, { label: "LEADERS", value: counts.leaders, icon: Shield, color: "text-slate-700 bg-slate-100" }, { label: "PROJECTS", value: counts.projects, icon: FolderKanban, color: "text-blue-700 bg-blue-50" }];
